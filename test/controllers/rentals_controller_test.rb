...
class RentalsControllerTest < ActionController::TestCase
  ...
  test "should create rental" do
    assert_difference('Rental.count') do
      post :create, rental: { date: @rental.date, rentalDuration: @rental.rentalDuration, type: @rental.type }
    end
  ...
  test "should update rental" do
    patch :update, id: @rental, rental: { date: @rental.date, rentalDuration: @rental.rentalDuration, type: @rental.type }
    assert_redirected_to rental_path(assigns(:rental))
  end
